...
SECRET_KEY = 'django-insecure-mk0sz3vt1-j5i8+i9#cz_lb^m5=a+s^($74$%emu7jdd1%u^t!'
...
MIDDLEWARE = [
    ...
    'foodflex.middleware.JWTMiddleware',
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.SessionAuthentication',  # Keep session auth as fallback
    ],
